package com.defferentimageview;
...
public class DefferentImageView extends ImageView {
    ...
    public static final int DEFAUT_ROUND_RADIUS = 20;//默认圆角大小

    public DefferentImageView(Context context) {
        this(context, null);
        // TODO Auto-generated constructor stub
    }

    public DefferentImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        // TODO Auto-generated constructor stub
    }

    public DefferentImageView(Context context, AttributeSet attrs, int defStyle) {
